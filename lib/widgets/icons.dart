...
abstract final class ZulipIcons {
  ...
  /// The Zulip custom icon "calendar".
  static const IconData calendar = IconData(0xf107, fontFamily: "Zulip Icons");
  ...
  /// The Zulip custom icon "more_vertical".
  static const IconData more_vertical = IconData(0xf128, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "mute".
  static const IconData mute = IconData(0xf129, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "person".
  static const IconData person = IconData(0xf12a, fontFamily: "Zulip Icons");
  ...
  static const IconData send = IconData(0xf130, fontFamily: "Zulip Icons");
  ...
  static const IconData topics = IconData(0xf139, fontFamily: "Zulip Icons");
